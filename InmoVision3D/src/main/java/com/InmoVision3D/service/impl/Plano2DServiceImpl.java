...
@Service
@Transactional
public class Plano2DServiceImpl implements Plano2DService {

    private final Plano2DRepository planoRepository;
    private final InmuebleRepository inmuebleRepository;

    public Plano2DServiceImpl(Plano2DRepository planoRepository, InmuebleRepository inmuebleRepository) {
